...
namespace moviesite
{
    public class SQLiteHelper
    {
        ...
        public static string ExecuteScalar(string sql, SQLiteParameter[] paras)
        {
        ...
        public static string ExecuteScalar(string sql, SQLiteParameter[] paras, CommandType cmdType)
        {
            string i="";
